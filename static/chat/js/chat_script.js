// This is not the main script. The main script is: main_chat_script.js
//this is a temp script and can be ignored.         
            ...
            function detectSilence(stream, onSoundEnd =_=>{}, onSoundStart =_=>{}, silence_delay = 2000, min_decibels = -80) {
              ...
              function onSilence() {
                //  {% comment %} log.textContent += 'silence\n'; {% endcomment %}
              ...
              function onSpeak(stream) {
                ...
                //  {% comment %} log.textContent += 'speaking\n'; {% endcomment %}
            ...
            //   {% comment %} navigator.mediaDevices.getUserMedia({
            //       audio: true
            //     })
            //     .then(stream => {
            //       detectSilence(stream, onSilence, onSpeak, 500, -70);
            //       // do something else with the stream
            //     }).catch(e=>log.textContent=e); {% endcomment %}
              
              



            //this is just the blob function
            ...
            document.querySelector('#start-recording').onclick = function() {
                this.disabled = true;
                // {% comment %} captureUserMedia(mediaConstraints, detectSilence, onMediaError); {% endcomment %}
